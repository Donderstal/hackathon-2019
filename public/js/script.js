...
var questions = [
  "Hello there, Soda Survey here with your five daily questions. Am I speaking to Sabina?",
  "Alright then, am I speaking to Peter?",
  "Oh hey Peter, good to hear from you! It is time for your first question, are you ready?",
  "On a scale from zero to ten, ten being highest, how likely are you to order a pizza online this month?"
];
var answers = [
  "Hello Google, please talk to Soda Survey. ",
  "No.",
  "Yes.",
  "Yes.",
  "Hahaha, I am eating a pizza now! TEN!"
];
...
recognition.onresult = function(event) {
  ...
  if (confidence < 0.75) {
    ...
    if (answers[step] == voiceTranscript) {
      text = questions[step];
      step++;
    } else {
      text = "I cannot understand what you said, please answer to question.";
    }
  }
